...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val indexDocumentResultListFormat = jsonFormat1(List[IndexDocumentResult])
  implicit val updateDocumentResultListFormat = jsonFormat1(List[UpdateDocumentResult])
  implicit val deleteDocumentResultListFormat = jsonFormat1(List[DeleteDocumentResult])
  ...
  implicit val termFormat = jsonFormat6(Term)
  implicit val updateTermFormat = jsonFormat6(UpdateTerm)
