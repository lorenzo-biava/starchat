...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val responseRequestOutputFormat = jsonFormat10(ResponseRequestOut)
  ...
  implicit val dtDocumentSearchFormat = jsonFormat5(DTDocumentSearch)
  ...
  implicit val dtRegexMapFormat = jsonFormat1(DTRegexMap)
  implicit val dtRegexLoadFormat = jsonFormat1(DTRegexLoad)
}
