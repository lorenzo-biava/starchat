...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val qaDocumentCoreUpdateFormat = jsonFormat8(QADocumentCore)
  implicit val qaDocumentAnnotationsUpdateFormat = jsonFormat14(QADocumentAnnotations)
  ...
  implicit val qaDocumentSearchFormat = jsonFormat17(QADocumentSearch)
